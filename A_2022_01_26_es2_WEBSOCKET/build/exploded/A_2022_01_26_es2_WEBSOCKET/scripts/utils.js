...
function parsificaJson( json ) { //Testo
	...
	var myRes = "Quadrato perfetto?:" + itemNodes.risultato + " Somma: "+itemNodes.somma+"<br>";
	return myRes;
...
function caricaFeed(e, data) {
	...
	if ( xhr1 ) {	
		caricaFeedAJAX("dis",e, jsonRequest,xhr1); 
	}
	if(xhr2){
	//	caricaFeedAJAX("pagina.jsp",e, jsonRequest,xhr2); 
	}
	else {
