...
function parsificaJson( xml ) { //Testo
	var itemNodes=JSON.parse(xml);
	var risultato = "<ul>";
...
/*
	for( var c = 0 , b=itemNodes.length; c <b ; c++ ) {
		//risultato+='<li class="item"><strong>' + itemNodes.title +'</strong><br/>';
		risultato += '<li class="item"><strong>' + itemNodes[c].title +'</strong><br/>';
		risultato += itemNodes[c].description +"<br/>";
		risultato += '<a href="' + itemNodes[c].link + '">approfondisci</a><br/></li>';
	};
