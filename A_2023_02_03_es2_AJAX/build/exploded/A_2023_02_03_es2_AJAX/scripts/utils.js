...
function parsificaJson( json ) { //Testo
	...
	var myRes = "Risultato:" + itemNodes.result;
	return myRes;
...
function caricaFeed(uri,e) {
	...
	var matrice1=document.getElementById("matrice1").value;
	var matrice2=document.getElementById("matrice2").value;
    data.matrice1=matrice1;
    data.matrice2=matrice2;
    data.numRighe=n;
    data.numColonne=m;
	var jsonRequest;
